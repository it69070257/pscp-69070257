...
```text
โจทย์ให้รับข้อมูล และบอกว่าเป็นไพ่แต้มอะไร

Input:
ไพ่ 2 ใบ

Output:
ไพ่ใบแรก of ไพ่ใบที่ 2

Constraints:
input ที่ต้องแบ่งเป็น 2 ตัวโดยไม่มีเว้นวรรค
```
...
```text
Step 1: รับอินพุท 2 ค่าแบบติดกัน
Step 2: แยกข้แมูลอินพุทออกมาเป็น 2 ข้อมูล
Step 3: ตรวจดูและ print ข้อมูลออกมา
```
...
```text
เพื่อดูว่าถ้าเป็น ตัวอักษร 2 ตัวจะเป็นยังไง
```
...
```text
เพื่อดูว่าถ้าเป็น ตัวอักษรใหญ่เล็กไม่เท่ากันจะเป็นยังไง
```
