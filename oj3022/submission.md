...
```text
โจทย์ให้เปลี่ยนอุณหภูมิ จากอันนึงเป็ฯอีกอันนึง

Input:
จำนวนจริงอุณหภูมิ
ค่าอุณหภูมิตอนแรก
ค่าอุณหภูมิที่จะเปลี่ยน 

Output:
เป็นจำนวนจริงเป็นอุณหภูมิ ตามหน่วยที่ตจ้องการเปลี่ยน(ทศนิยม 2 ตำแหน่ง)

Constraints:
มีสูตรในการเปลี่ยนที่ต้องเขียนดีๆ และคำตอบที่เอาทศนิยม
```
...
```text
Step 1: รับ input ต่างๆตามที่โจทย์ต้องการ
Step 2: ตรวจ input ตัวที่ 2 ให้เป็น celsius ทั้งหมด
Step 3: ตรวจ input ตัวที่ 3 และเปลี่ยน celsius ให้เป็น input ตัวที่ 3
Step 4: print คำตอบที่เปลี่ยนค่าแล้วเรียบร้อย(ทศนิยม 2 ตำแหน่ง)
```
...
```text
ตอนแรกผมใช้ if elif สร้างเงื่อนไขเปลี่ยน อุณหภูมิทุกตัว มันทำให้โค้ดทั้งยาวและมึน สุดท้ายผมเลยเปลี่ยนให้เป็นอุณหถูมิตัวกลางหรือก็คือ celsius ทำให้ง่ายกว่าเดิมเยอะ
```
