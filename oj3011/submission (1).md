...
```text
โจทย์ให้แม่สี (Primary Color) มี 3 สี คือ สีแดง (Red) สีเหลือง (Yellow) และสีน้ำเงิน (Blue) แล้วนำมาผสมกัน

Input:
2 บรรทัด เป็นชื่อสี 

Output:
ออหมาเป็น  1 บรรทัด เป็นชื่อสี หรือ Error

Constraints:
ต้องระวังเพราะถ้ามีสีอื่นที่ไม่ใช่แม่สีมาผสม ให้ตอบว่า Error
```
...
```text
Step 1: รับค่าสีมา  2 ค่า
Step 2: ตรวจตามเงื่อนไขว่าสีอะไรผสมสีอะไร แล้วได้ออกมาเป็นอะไร
Step 3: print สีที่ได้ออกมา จากเงื่อนไขที่มี
Step 4: ตรวจสอบ หารับค่าสีที่ไม่มีในเงื่อนไขให้ print "ERROR"
```
...
```text
วิธีสุดท้ายใช้เหมือนตอนแรก แค่เพิ่มเงื่อนไขให้มันเพิ่ม เพราะมี testcaseที่ไม่ผ่าน
```
...
```text
ตรวจสอบว่าถ้ามีนอกเหนือแม่สีจะเป็นไง
```
