...
```text
โจทย์ให้ตรวจดูว่าได้เงินจากการถูกหวยเท่าไหร่

Input:
ตัวอักษร 1 ตัว และชุดตัวเลข

Output:
แสดงเงินที่ได้จากถุกหวย

Constraints:
เงื่อนไขต่างๆที่ต้องดูดีๆ
```
...
```text
Step 1: รับ อินพุทตามที่โจทย์ต้องการ
Step 2: ตรวจดูเงื่อนไขตามที่โจทย์ระบุมา
Step 3: แสดงผล เงินที่ได้จากสลากกินแบ่ง
```
...
```text
เพื่อตรวจดูว่าเงื่อนไขถูกต้องมั้ย
```
