...
```text
โจทย์ให้ตรวจดูว่า input ที่ใส่ไปมี สระ กี่ตัว
...
Constraints:
การเก็บข้อมูลไว้ใน list และนำออกมาใช้
```
...
```text
Step 1: รับ input 
Step 2: สร้าง list ที่เก็ฐสระเอาไว้ใช้
Step 3: ใช้ลูปเพื่อนับว่า มีสระกี่ตัวใน input
Step 4: print คำตอบออกมา
```
...
```text
เหมือนกับวิธีแรก  การเก็บข้อมูลไว้ใน list อย่าง vowels = ['a', 'e', 'i', 'o', 'u'] และกัรรับข้อมูลอย่าง text = input().lower() เพื่อไม่ให้มีปัญหาในการนับสระ
```
...
```text
เพื่อดูว่าถ้ามี ตัวอักษรพิเศษจะเป็นยังไง
```
