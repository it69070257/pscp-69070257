...
```text
โจทย์ให้ฉันเขียนข้อความและสลับตัวอักษรจากหน้าไปหลัง
...
Constraints:
กลับด้านเป็นตัวพิมพ์เล็กเท่านั้น
```
...
```text
Step 1: รับข้อความ
Step 2: ตรวจว่ามี 5 อักษรมั้ย
Step 3: ถ้าจริง ให้สลับตัวอักษรเป็นตัวพิมย์เล็ก
```
...
```text
เช็คว่าเป็นตัวพิมย์เล็กหมดมั้ย
