...
```text
โจทย์ให้คิดโปรแกรม ที่จะดูว่าเป็ฯ season อะไร
...
Output:
ชื่อฤดูกาล (spring, summer, fall, winter)

Constraints:
 ฤดูกาลจะเปลี่ยนไปตั้งแต่วันที่ 21 ของเดือนที่ 3 ที่หารลงตัว เพราะงั้นจึงต้องระวังในส่วนนี้
```
...
```text
Step 1: รับ input ตามที่โจทย์ต้องการ
Step 2: สร้างเงื่อนไขตามที่โจทย์ต้องการทั้งหมด
Step 3: พร้อม print คำตอบ
```
...
```text
วิธีสุดท้าย้หมือนกับวิธีแรก การสร้างเงื่อนไขอย่าง 
...
```text
เพื่อดูว่าเงื่อนไขที่เขียนถูกต้องไหม
```
