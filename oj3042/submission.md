...
```text
โจทย์ให้เขียนโปรแกรมว่า input ที่รับค่าไปมีเลขอะไรบ้างที่หารด้วย 10 ลงตัว

Input:
รับข้อมูลจำนวนเต็มบวก N

Output:
แสดงจำนวนเต็มบวกตั้งแต่ N ถึง 0 ที่หารด้วย 10 ลงตัว (คั่นข้อมูลแต่ละตัวด้วยช่องว่าง)

Constraints:
การใช้ list เก็บคำตอบและแสดงออกมาพร้อมๆกัน
```
...
```text
Step 1: รับ input ตัวเลขที่เราจะหาร
Step 2: สร้าง list ขึ้นมาเพื่อไว้เก็บคำตอบ
Step 3: วนลูปเพื่อหาร input และเก็บคำตอบไว้ใน list
Step 4: ปริ้นคำตอบออกมา
```
...
```text
วิธีสุดท้ายใช้เหมือนวิธีแรก เก็บคำตอบไว้ใน list และปริ้นออกมาด้วย (" ".join(result))
```
...
```text
เป็นตัวอย่างที่เข้าใจง่าย และชัดเจน
```
