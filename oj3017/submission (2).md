...
```text
โจทย์ให้คำนวนหาจำนวนเงินที่ลูกค้าต้องจ่ายหลังจากรวมค่าบริการและ VAT เรียบร้อยแล้ว 
...
Constraints:
โจทย์ให้แสดง output เป็นทศนิยม 2 หลัก และการคำนวณ vat% ก็ต้องรวมกับค่าอาหาร และค่าบริการต่างๆ
```
...
```text
Step 1: รับค่า input เข้ามาเป็นจำนวณเงินที่รวมค่าอาหารเครื่องดื่มแล้ว
Step 2: สร้างเงื่อนไขขึ้นมา ให้ค่าบริการ มีค่าขั้นต่ำเป็น 50 บาท และจะไม่เกิน 1000 บาท
Step 3: จากนั้นคำนวณค่า vat จากค่าอาหารต่างๆรวมกับ ค่าบริการแล้ว 
Step 4: print คำตอบออกมาโดยให้คำตอบมีทศนิยม 2 ตำแหน่ง
```
...
```text
เป็นจำนวณพื้นฐานที่เข้าใจง่าย และดูค่าบริการขั้นต่ำ
```
...
```text
เป็นจำนวณที่เยอะขึ้นและได้ดูค่าทศนินย
```
...
```text
เพื่อตรวจสอบว่าค่าบริการจะมากกว่า 1000 หรือป่าว
```
