...
| OJ submission ID, if submitted | 587121 |
| OJ status | Pass |
...
```text
ถาม AI ให้ช่วยตีโจทย์พร้อมกับสูตรคณิตที่น่าจะเกี่ยวข้อง
```
...
```text
ผมเอาสูตรที่ได้ ไปลองคำนวณและเขียนดู หลักๆก็จะมีแต่เรื่องสูตรเพราะผมไม่เก่งคณิต
```
...
```text
ได้เรียนรู้สูตร การหาพิกัด (0,0) ถึง (x,y)  และได้รู้สูตรคำนวณเวลาอย่าง T = A/S
```
