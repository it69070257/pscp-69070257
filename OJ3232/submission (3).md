...
```text
โจทย์ให้คำนวณรจำนวณครั้งที่กบจะต้แงกระโดดเพื่อไปถึงเป้าหมาย

Input:
รับระยะทางที่กบกระโดดได้ และ ระยะทางเป้าหมายที่กบต้องไป

Output:
จำนวณครั้งที่กบกระโดด หรือถ้าไม่ถึงให้ตอบ -1

Constraints:
ทุกครั้งที่กบกระโดด ระยะทางที่กบจะกระโดดได้ครั้งต่อไปจะ -2
```
...
```text
Step 1: รับค่าอินพุทตามที่โจทย์ต้องการ
Step 2: ตรวจดูว่ากบจะต้องกระโดดกี่ครั้งพร้อมลบระยะที่กบจะกระโดดครั้งต่อไป
Step 3: ถ้าไปถึงก็ก็แสดงจำนวณที่ต้องกระโดด
Step 4: แต่ถ้าไม่ถึงให้แสดง -1
```
...
```text
เพื่อดูว่าถ้าไปถึงจะแสดงถูกต้องมั้ย
```
