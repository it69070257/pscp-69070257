...
```text
โจทย์ให้เชียนโปรแกรมเพื่อดูว่าคนจะ surprise มั้ย

Input:
คะแนนรวมของทั้ง 3 คน
...
Constraints:
ข้อนี้ต้องตีโจทย์ให้แตก ไม่งั้นจะงงมาก และคิดวิธีไม่ออก
```
...
```text
Step 1: รับค่า input ตามที่โจทย์ต้องการ
Step 2: ลบคะแนนทั้งหมดด้วยคะแนนสูงสุดของทั้ง 3 คน
Step 3: หาค่าคนที่ 2 ที่เยอะที่สุดเท่าที่จะเป็นไปได้ หรือก็คือ max == min
Step 4: ตรวดูว่าคะแนนห่างกันเท่าไหร และตรงตามเงื่อนไขมั้ย
Step 5: print คำตอบ
```
...
```text
วิธีสุดท้าย เหมือนกับวิธีแรก max == min และตรวจว่า > 2 มั้ย จากนั้นปริ้นคำตอบ
```
...
```text
ตรวจว่าเงื่อนไขที่สร้างถูกมั้ย
```
