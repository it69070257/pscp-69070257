...
```text
โจทย์ให้ฉันหาก้อนอิฐก้อนเล็กที่น้อยที่สุดในการสร้างสะพาน
...
Constraints:
การคำนวณหาอิฐก้อนใหญ่ท่น้อยที่สุดและมากที่สุดโดยที่ไม่เกิน
```
...
Step 2: หาว่าจะใช้อิฐก้อนใหญ่ที่น้อยที่สุด
Step 3: นำไปลบและหาก้แนหินก้อนเล็กที่ยังขาด
Step 4: ตรวจดูว่าก้อนเล็กพอสำหรับการสร้างมั้ย
step: 5 แสดงคำตอบออกมาตามที่โจทย์ต้องการ
...
```text
วิธีสุดท้ายเหมือนวิธีแรก อย่างการใช้ use_b = min(b, goal // 5) เพื่อหาหินที่น้อยที่สุด
```
