...
```text
โจทย์ให้ให้ A และ B เป็นจํานวนนับ โดยที่ A < B
...
Output:
จํานวนข้อมูลที่สอดคล้อง N :

Constraints:
การสร้างลูปตรวจข้อมูลใน range และทำตามเงื่อนไข
```
...
Step 2: สร้างตัวแปร count = 0 เอาไว้ใช้
Step 3: for loop ตัวแปรให้อยู๋ใน range ที่กำหนด
Step 4: ถ้าเงื่อนไขถูกให้เพิ่มค่า count
Step 5: print คำตอบ
```
...
```text
วิธีสุดท้ายเหมือนวิธีแรก การใช้
...
```text
ลองดูจำนวณที่เยอะขึ้น และเป็นเลขที่เข้าใจง่าย
```
