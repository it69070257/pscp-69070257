...
```text
โจทย์ให้หาว่าจะใช้เงินเท่าไหร่ในการส่งของ

Input:
สถานที่ต้นทาง สถานที่ปลายทาง  ระยะทาง

Output:
ราคาค่าขนส่ง

Constraints:
โจทย์ให้ตารางมา และก็ต้องกรอกข้อมูลตามตาราง
```
...
```text
Step 1: รับข้อมูลตามที่โจทย์บอก
Step 2: ตรวจดูสถานที่ต้นทางและปลายตาง
Step 3: จากนั้นก็คำนวณค่าใช้จ่ายตั้งหมด
```
...
```text
วิธีสุดท้ายเหมือนกับวิธีแรก การใช้ if elif else  
```
...
```text
เพื่อจะดูว่าเงื่อนไขถูกต้องมั้ย
```
